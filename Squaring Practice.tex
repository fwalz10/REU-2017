...
If you have a term such as $\ou_1 \ga^\mu u_2 \ou_2 \ga_\mu u_1$ you need to state explicitly that the indices are not summed because that is the convention with an expression such as $\ga^\mu \ga_\mu$. Also with the upper and lowering of matrices that implies a change of basis since you cannot arbitrarily raise/lower and index.
