...
\eea 
Returning to Equation 121 we now have:~(With $(\frac{g_w^2}{8m_w^2}f_\pi)^2 = C) $ 
\bea 
...
\bea 
\Ga &=& \frac{S|\textbf{p}|}{8\pi m_1^2} |\mathcal{M}|^2\\
\Ga &=& \frac{S|\textbf{p}|}{8\pi m_\pi^2}(\frac{g_w^2}{8m_w^2}f_\pi)^2[\frac{1}{2}(m_l)^2((m_\pi)^2 -(m_l)^2)]
\eea 
We can remove S because in this case S=1\\
We then need to find the value of$|\textbf{p}|$\\
\bea
|\textbf{p}| &=& \frac{\sqrt{(m_1^2+m_2^2+m_3^2)(m_1^2-m_2^2-m_3^2)(m_1^2+m_2^2-m_3^2)(m_1^2-m_2^2+m_3^2)}}{2m_1}\\
...
\bea 
\Ga &=& \frac{|\textbf{p}|}{8\pi m_1^2}(\frac{g_w^2}{8m_w^2}f_\pi)^2[\frac{1}{2}(m_l)^2((m_\pi)^2 -(m_l)^2)]\\
\Ga &=& \frac{\frac{(m_\pi^2-m_l^2)}{2m_\pi}}{8\pi m_\pi^2}(\frac{g_w^2}{8m_w^2}f_\pi)^2[\frac{1}{2}(m_l)^2((m_\pi)^2 -(m_l)^2)]\\
\Ga &=& \frac{1}{16\pi}(\frac{g_w^2f_\pi}{8m_w^2})^2\frac{1}{m_\pi^3}m_l^2(m_\pi^2-m_l^2)^2
\eea 
Expanding on this idea, we are able to graph $\frac{\Ga_l}{\Ga_\pi}$ by:\nl 
\bea
\Ga &=& \frac{1}{16\pi}(\frac{g_w^2f_\pi}{8m_w^2})^2\frac{1}{m_\pi^3}m_l^2(m_\pi^2-m_l^2)^2\\
\Ga &=& \frac{1}{16\pi}(\frac{g_w^2f_\pi}{8m_w^2})^2\frac{1}{m_\pi^3}m_l^2m_\pi^4(1-\frac{m_l^2}{m_\pi^2})\\
\Ga &=& \frac{1}{16\pi}(\frac{g_w^2f_\pi}{8m_w^2})^2m_l^2m_\pi(1-\frac{m_l^2}{m_\pi^2})\\
\Ga &=& \frac{1}{16\pi}(\frac{g_w^2f_\pi}{8m_w^2})^2m_\pi^3\frac{m_l^2}{m_\pi^2}(1-\frac{m_l^2}{m_\pi^2})\\
\Ga &=& \frac{1}{16\pi}(\frac{g_w^2f_\pi}{8m_w^2})^2m_\pi^3(\frac{m_l}{m_\pi})^2(1-(\frac{m_l}{m_\pi})^2)\\
\eea
The graph of the equation is:
\begin{figure}[h]
\centering
\includegraphics[scale=.65]{brpion4}
