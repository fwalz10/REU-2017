...
\bea
\Ga_l &=& \frac{f_\pi^2}{\pi m_\pi^3}(\frac{g_w}{4m_w})^4 m_l^2(m_\pi^2-m_l^2)^2 \\
\frac{\Ga_l}{\Ga_\pi} &=&  \frac{\frac{f_\pi^2}{\pi m_\pi^3}(\frac{g_w}{4m_w})^4 m_l^2(m_\pi^2-m_l^2)^2}{m_\pi}
\eea
\\
\\
\\
...
\begin{figure}[h]
\centering
\includegraphics[scale=.65]{brpion3}
