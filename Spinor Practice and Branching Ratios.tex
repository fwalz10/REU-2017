...
\langle|\mathcal{M}^2|\rangle&=&\bigg(\frac{g_w^2}{8 m_w^2}f_\pi\bigg)^2p_\mu p_\nu Tr[(u(3)\ou(3)(\ga^\mu(1-\ga^5))v(2) \ov(2)(\ga^\nu(1-\ga^5))]\\
...
$(p_1)^2 =(p_\pi)^2 = m_1^2 , (p_2)^2 = (p_l)^2 = m_l^2 , (p_3)^2= (p_{\nu_l})^2 = (m_{\nu_l})^2 = 0$
Using this we can further simplify Equation 121
\bea 
p_1 &=& p_2 + p_3\\ 
(p_1)^2 &=& (p_2 + p_3)(p_2 + p_3)\\
(p_1)^2 &=& (p_2)^2 + (p_3)^2 +2(p_2 \cdot p_3)\\
(p_1)^2 -(p_2)^2 &=& 2(p_2 \cdot p_3)\\
\frac{1}{2}[(m_\pi)^2 -(m_l)^2] &=& (p_2 \cdot p_3)
\eea 
\bea 
p_1 &=& p_2 + p_3\\ 
(p_2)^2 &=& (p_1 - p_3)(p_1 - p_3)\\
(p_2)^2 &=& (p_1)^2 + (p_3)^2 -2(p_1 \cdot p_3)\\
(p_2)^2 -(p_1)^2 &=& -2(p_1 \cdot p_3)\\
\frac{1}{2}[(m_\pi)^2 -(m_l)^2] &=& (p_1 \cdot p_3)
\eea 
\bea 
p_1 &=& p_2 + p_3\\ 
(p_3)^2 &=& (p_1 - p_2)(p_1 - p_2)\\
(p_3)^2 &=& (p_1)^2 + (p_2)^2 -2(p_1 \cdot p_2)\\
-(p_1)^2 -(p_2)^2 &=& -2(p_1 \cdot p_2)\\
\frac{1}{2}[(m_\pi)^2 +(m_l)^2] &=& (p_1 \cdot p_2)
\eea 
Returning to Equation 121 we now have:~(With $8(\frac{g_w^2}{8m_w^2}f_\pi)^2 = C) $ 
\bea 
\langle|\mathcal{M}^2|\rangle&=&C[2(p_1\cdot p_2)(p_1 \cdot p_3) -p^2(p_2 \cdot p_3)]\\
\langle|\mathcal{M}^2|\rangle&=&C[\frac{1}{2}[(m_\pi)^2 +(m_l)^2][(m_\pi)^2 -(m_l)^2] -(m_\pi)^2(\frac{1}{2}((m_\pi)^2 -(m_l)^2)]\\
\langle|\mathcal{M}^2|\rangle&=&C[[\frac{1}{2}[(m_\pi)^4 -(m_l)^4 )]- [\frac{1}{2}((m_\pi)^4 +(m_\pi)^2(m_l)^2)]\\
\langle|\mathcal{M}^2|\rangle&=&C[\frac{1}{2}(m_\pi)^4 - \frac{1}{2}(m_l)^4 - \frac{1}{2}(m_\pi)^4 + \frac{1}{2}(m_\pi)^2(m_l)^2]\\
\langle|\mathcal{M}^2|\rangle&=&C[-\frac{1}{2}(m_l)^4 + \frac{1}{2}(m_\pi)^2(m_l)^2]\\
\langle|\mathcal{M}^2|\rangle&=&C[- \frac{1}{2}(m_l)^4 + \frac{1}{2}(m_\pi)^2(m_l)^2)]\\
\langle|\mathcal{M}^2|\rangle&=&C[\frac{1}{2}(m_\pi)^2(m_l)^2- \frac{1}{2}(m_l)^4]\\
\langle|\mathcal{M}^2|\rangle&=&C[\frac{1}{2}(m_l)^2((m_\pi)^2- (m_l)^2)]\\
\eea 
...
\bea 
\Ga &=& \frac{S|\textbf{p}|}{8\pi m_1^2} |\mathcal{M}|^2\\
\Ga &=& \frac{S|\textbf{p}|}{8\pi m_\pi^2}8\bigg(\frac{g_w^2}{8m_w^2}f_\pi\bigg)^2\bigg[\frac{1}{2}(m_l)^2((m_\pi)^2 -(m_l)^2)\bigg]
\eea 
...
\bea
|\textbf{p}| &=& \frac{\sqrt{(m_\pi^2-m_l^2)^2}}{2m_\pi}\\
|\textbf{p}| &=& \frac{(m_\pi^2-m_l^2)}{2m_\pi}\\
\eea
Combining with Equation 153: 
\bea 
\Ga &=& \frac{|\textbf{p}|}{8\pi m_1^2}\bigg(\frac{g_w^2}{8m_w^2}f_\pi\bigg)^2\bigg[\frac{1}{2}(m_l)^2((m_\pi)^2 -(m_l)^2)\bigg]\\
\Ga &=& \frac{\frac{(m_\pi^2-m_l^2)}{2m_\pi}}{\pi m_\pi^2}\bigg(\frac{g_w^2}{m_w^2}f_\pi\bigg)^2\bigg[\frac{1}{2}(m_l)^2((m_\pi)^2 -(m_l)^2)\bigg]\\
...
\bea
\Ga &=& \frac{1}{4\pi}\bigg(\frac{g_w^2f_\pi}{8m_w^2}\bigg)^2\frac{1}{m_\pi^3}m_l^2(m_\pi^2-m_l^2)^2\\
\Ga &=& \frac{1}{4\pi}\bigg(\frac{g_w^2f_\pi}{8m_w^2}\bigg)^2\frac{1}{m_\pi^3}m_l^2m_\pi^4\bigg(1-\frac{m_l^2}{m_\pi^2}\bigg)^2\\
\Ga &=& \frac{1}{4\pi}\bigg(\frac{g_w^2f_\pi}{8m_w^2}\bigg)^2m_l^2m_\pi\bigg(1-\frac{m_l^2}{m_\pi^2}\bigg)^2\\
\Ga &=& \frac{1}{4\pi}\bigg(\frac{g_w^2f_\pi}{8m_w^2}\bigg)^2m_\pi^3\frac{m_l^2}{m_\pi^2}\bigg(1-\frac{m_l^2}{m_\pi^2}\bigg)^2\\
\Ga &=& \frac{1}{4\pi}\bigg(\frac{g_w^2f_\pi}{8m_w^2}\bigg)^2m_\pi^3\bigg(\frac{m_l}{m_\pi}\bigg)^2\bigg(1-\bigg(\frac{m_l}{m_\pi}\bigg)^2\bigg)^2\\
\Ga &=& \frac{1}{4\pi}\bigg(\frac{G_f f_\pi}{\sqrt{2}}\bigg)^2m_\pi^3\bigg(\frac{m_l}{m_\pi}\bigg)^2\bigg(1-\bigg(\frac{m_l}{m_\pi}\bigg)^2\bigg)^2\\
...
\begin{figure}[h]
\centering
\includegraphics[scale=.75]{brpionme}
...
\begin{figure}[h]
\centering
\includegraphics[scale=.5]{brpionmmu}
...
\\
We seek to find the constraints on the parameters $C_S, C_S^{'},C_P, C_P^{'},C_A,$ and $C_A^{'}$\\
\\
Setting the equation equal to the branching ratio given in \cite{flavio} and using the values for $C_{10},|V_{tb} V_{ts}^*|, g_{NP},$ and $\Lambda$ given in \cite{Dighe:2012df}
We are able to find the constraints on the parameters. \\
\\
The values for the Branching ratio of $B_s\rightarrow \mu^+\mu^- $ decay is equal to $2.4_{-0.7}^{+0.9} \times 10^{-9}$ \cite{Agashe:2014kda}\\
\\
In order to solve for one parameter, we allow the other two to be equal to 0, this will simply our calculations.\\
\\
We wish to make three measurements of each parameter and solve for the average and the standard deviation. We solve for each coefficient by setting the expression with the unknown coefficient equal to the branching ratio, the upper limit of the branching ratio, and its lower limit. 
\bea
...
\\
We again only apply one Wilson Coefficient at a time to find the branching ratio:\\ 
For the $C_S$:
\begin{center}
...
\begin{figure}[h]
\centering
\includegraphics[scale=.65]{B(WC)forB-Kmumu}
